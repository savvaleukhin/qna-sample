...
ActiveRecord::Schema.define(version: 20150519165851) do
  ...
  add_index "subscriptions", ["subscriber_id", "tracking_question_id"], name: "index_subscriptions_on_subscriber_id_and_tracking_question_id", unique: true, using: :btree
  add_index "subscriptions", ["subscriber_id"], name: "index_subscriptions_on_subscriber_id", using: :btree
  add_index "subscriptions", ["tracking_question_id"], name: "index_subscriptions_on_tracking_question_id", using: :btree
