...
feature 'Create answer', %q{
  ...
  scenario 'Authenticated user creates an answer using AJAX', js: true, data: { type: :json } do
    sign_in(user)
  ...
  scenario 'User tries to create invalid answer using AJAX', js: true, data: { type: :json } do
    sign_in(user)
